...
Registradores (ARISP) Certidão: Download de Recibo segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [registradores_certid_recibo@mcp.ai](mailto:registradores_certid_recibo@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
